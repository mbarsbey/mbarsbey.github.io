...
- Kurutmaz, M. B.\*, **Barsbey, M.\***, Cemgil, A. T., Yıldırım, S., & Şimşekli, U. _Bayesian Model Selection for Identifying Markov Equivalent Causal Graphs_, submitted to _Advances in Approximate Bayesian Inference_, 2019. \*Equal contribution
